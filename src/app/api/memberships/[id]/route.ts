...
export async function POST(request: Request) {
  try {
    ...
    // Recalculer les prix des workshops pour ce membre
    // Car maintenant il a une adhésion, il peut bénéficier du discount familial
    await registrationService.recalculateWorkshopPricesForMember(
      data.memberId,
      data.seasonId
    );
